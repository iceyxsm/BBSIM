...
Write-Host "[2/3] Starting Vite dev server (port 5174)..." -ForegroundColor Yellow
$vite = Start-Process -FilePath "pnpm" -ArgumentList "--filter @bbsim/trader dev" -WorkingDirectory $root -PassThru -NoNewWindow
